...
R/RStudio), clone the pre-generated code for this exercise from GitHub, and run
the provided analysis code. The latter downloads genome-wide expression data
...
Instead of RStudio Cloud, users can install everything on their local computer
...
Note, students who are entirely new to R should use this approach:

1. Create a free personal account on RStudio Cloud
   [here](https://rstudio.cloud/). 
2. Next click the <span style="background-color: #f1c40f;">RStudio Cloud assignment link</span></a> provided under the same name
   and color coding on the corresponding assignment page on Canvas
   [here](https://elearn.ucr.edu/courses/17258/assignments/180492). Not only
   the latter page is private to this class.
3. Start the pregenerated assignment.
4. Continue under section 1.2 and skip R package install under section 2.

### B. Clone assignment from GitHub
...
5. Continue under section 1.2. Note the R package installs under section 2 will be 
...
2. Execute code by placing your cursor on a line of R code and then pressing
...
users want to skip this step after restarting R or rerunning the analysis.
...
same one used for the online exercises of computer section SA5. This
