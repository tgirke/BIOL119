...
The following provides clones the pregenerated code from GitHub into an R project on RStudio Cloud.
...
5. Prior to committing/pushing to GitHub the first time, set your GitHub identity with:
