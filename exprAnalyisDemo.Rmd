...
Note, students who are entirely new to R should use this approach (A) instead of (B):
...
2. Next click the <span style="background-color: #f1c40f;">RStudio Cloud assignment link</span></a> provided under the same name
   ...
   [here](https://elearn.ucr.edu/courses/17258/assignments/180492). Note
...
or rerunning the analysis. Users who loaded the the pre-configured assignment
